    ...
    <div>
      <header className={style.header_logado}>
        ...
        <nav className={style.navegation}>
          <Link to={"/posts/all?category=all"} className={style.links_header}>
            Todos
          </Link>
          <Link to={"/posts/all?category=lost"} className={style.links_header}>
            Achados
          </Link>
          <Link to={"/posts/all?category=found"} className={style.links_header}>
            Perdidos
          </Link>
