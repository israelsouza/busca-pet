  ...
  return (
    <>
        ...
        <div className={style.header__nav}>
          <nav>
            <ul className={style.header__ul}>
              <Link
                className={style.header__linkhome}
                onClick={irParaReencontros}
              >
                Reencontros
              </Link>
              <Link
                className={style.header__linkhome}
                onClick={irParaFuncionamento}
              >
                Como Funciona
              </Link>
              <Link className={style.header__linkhome} onClick={irParaColabore}>
                Colabore
              </Link>
            </ul>
          </nav>
      ...
      <div>
        <img
          src={home}
          alt="Mulher segurando cachorro no alto"
          className={style.home_principal}
        />
      ...
      <div id="reencontros" ref={sessaoReencontros}>
        ...
        <div className={style.containerAvaliacoes}>
          <AvaliacaoHome
            image_perfil={pessoa01}
            usuario_text="Paulo, MG"
            avaliacao_text="Nosso site facilitou o reencontro do meu gato em só dois dias! O apoio da comunidade foi enorme e muito valioso."
          />
          <AvaliacaoHome
            image_perfil={pessoa02}
            usuario_text="Fernando, SC"
            avaliacao_text="Meu gato perdido voltou em 48h, pura alegria! O site e seus usuários, de fato, fizeram a diferença."
          />
          <AvaliacaoHome
            image_perfil={pessoa03}
            usuario_text="Ana Paula, SP"
            avaliacao_text="Graças ao site, reencontrei meu cachorro em apenas dois dias! A comunidade é incrível e ajudou a espalhar a mensagem."
          />
        </div>
      </div>
      ...
      <div id="funcionamento" ref={sessaoFuncionamento}>
        ...
        <div>
          <ComoFunciona
            text_instrucao="1 - Cadastre-se"
            text_explicacao="Crie uma conta em poucos passos e tenha acesso à nossa plataforma. Com seu cadastro, você poderá registrar pets perdidos ou encontrados e se conectar com outras pessoas que possam ajudar."
          />
          <ComoFunciona
            text_instrucao="2 - Faça uma publicação"
            text_explicacao="Insira as informações do pet, como nome, raça, cor e local onde foi perdido ou encontrado. Adicione fotos para facilitar a identificação e aumente as chances de um reencontro rápido."
          />
          <ComoFunciona
            text_instrucao="3 - Fique de olho em seu e-mail"
            text_explicacao="Quando alguém encontrar um pet semelhante ao que você cadastrou ou quiser entrar em contato sobre um animal encontrado, você receberá uma notificação por e-mail. Fique atento para não perder nenhuma atualização!"
          />
        </div>
      </div>
        ...
        <article className={style.article}>
          <div className={style.article_text}>
            ...
            <p className={style.p1}>
              Seu engajamento faz a diferença! Compartilhe nosso site com
              amigos, vizinhos e grupos locais. Quanto mais pessoas
              participarem, maior a chance de reencontros felizes.
            </p>
          </div>
          <div className={style.article_img}>
            <img
              src={abraco_dogHome}
              alt="Mulher agachada abraçando carinhosamente um cachorro"
            />
          </div>
        </article>
      </div>
