...
function PetEncontrado() {
  ...
  async function validarFormulario(e) {
    ...
    if (
      validarDataLimite({
        ...
        setErro: setErroData,
        mensagemObrigatoria:
          "Por favor, insira a data em que viu o pet pela última vez.",
  ...
  async function exibirMapa() {
    if (
      !infoMapa ||
      typeof infoMapa.lat === "undefined" ||
      typeof infoMapa.lng === "undefined"
    ) {
          ...
          <div className={styles.pet_perdido__box}>
            <form>
              <div className={styles.pet_perdido__input100}>
                <label className={styles.label} htmlFor="tipoPet">
